...
export const MARGIN_ON_SIDES = 50;
export const BREAKPOINT_COLUMN_OBJECT = {
  default: 3,
  1100: 2,
  600: 1,
};

export const MINI_BREAKPOINT_COLUMN_OBJECT = {
  default: 4,
  1100: 3,
  600: 2,
};
...
export const SRC_FULL_HEIGHT = 600;
export const MOBILE_CONDITION = 600;
